...
const UserCardSection = () => {
    ...
    {!error && profiles.length > 0 && <View style={{marginTop: 20}}>
       <View style={styles.userGrid}>
         <UserCard user={profiles[0]}/>
         <UserCard user={profiles[1]}/>
       </View>
    </View>}
...
const [showUserCard, setShowUserCard] = React.useState(false);
    ...
    return (
        ...
        <View style={{flex: 1, justifyContent: 'flex-start', alignItems: 'center'}}>
            ...
            <Text style={{fontSize: 20, fontWeight: 'bold'}} onPress={() => {
                if (showSkeletons) setShowSkeletons(false);
                setShowUserCard(!showUserCard);
            }}>
                {showUserCard ? 'Hide' : 'Show'} User Card
            </Text>
            {showSkeletons && <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.userGrid}>
